...
CFG_FEATURE_TCM_PART_RETENTION    := FEATURE_ON
...
CFG_CONFIG_MODEM_ASLR := NO
else
CFG_STACK_CANARY_COMPILE := YES
CFG_CONFIG_MODEM_ASLR := YES
endif
CFG_CONFIG_COLD_PATCH := YES
CFG_CONFIG_RFS_SERVER := NO
